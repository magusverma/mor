...
int main(int argc, char const *argv[])
{
    ...
    src_imgs[0] = imread("../input/vlcsnap-2014-11-20-14h22m55s6.tiff", CV_8UC3);
    src_imgs[1] = imread("../input/vlcsnap-2014-11-20-14h22m55s8.tiff", CV_8UC3);
    src_imgs[2] = imread("../input/vlcsnap-2014-11-20-14h22m55s10.tiff", CV_8UC3);
    src_imgs[3] = imread("../input/vlcsnap-2014-11-20-14h22m55s12.tiff", CV_8UC3);
    src_imgs[4] = imread("../input/vlcsnap-2014-11-20-14h22m55s14.tiff", CV_8UC3);
    src_imgs[5] = imread("../input/vlcsnap-2014-11-20-14h22m56s16.tiff", CV_8UC3);
    src_imgs[6] = imread("../input/vlcsnap-2014-11-20-14h22m56s18.tiff", CV_8UC3);
    src_imgs[7] = imread("../input/vlcsnap-2014-11-20-14h22m56s20.tiff", CV_8UC3);
    src_imgs[8] = imread("../input/vlcsnap-2014-11-20-14h22m56s22.tiff", CV_8UC3);
    src_imgs[9] = imread("../input/vlcsnap-2014-11-20-14h22m56s24.tiff", CV_8UC3);
    src_imgs[10] = imread("../input/vlcsnap-2014-11-20-14h22m57s26.tiff", CV_8UC3);
    src_imgs[11] = imread("../input/vlcsnap-2014-11-20-14h22m57s28.tiff", CV_8UC3);
    src_imgs[12] = imread("../input/vlcsnap-2014-11-20-14h22m57s30.tiff", CV_8UC3);
...
void median(Mat* src_imgs, Mat& dst) {
    ...
    for (int i = 0; i < src_imgs[0].rows; ++i)
    {
        ...
        {
            vector<int> pixels[3];
            for (int k = 0; k < input_img_count; ++k)
            {
                for (int l = 0; l < 3; ++l)
                {
                    pixels[l].push_back(color_channels[k][l].at<uchar>(i, j));
                }
            }
